...
<!doctype html><html><head><meta charset="utf-8"><title>Outbound Scan</title>
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.6.2/dist/css/bootstrap.min.css">
<script src="https://unpkg.com/html5-qrcode@2.3.8/minified/html5-qrcode.min.js"></script>
</head><body class="p-4">
<div class="container">
    <h1>Outbound - Scan QR</h1>
    ...
    <form id="manualForm">
        ...
        <button id="submitBtn" class="btn btn-primary">Proses Outbound</button>
    </form>
...
document.getElementById('manualForm').addEventListener('submit', function(e){
    ...
    fetch('<?php echo site_url('outbound/process'); ?>', {
        method: 'POST',
